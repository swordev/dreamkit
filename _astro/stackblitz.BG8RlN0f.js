...
</html>`}function K(e,t){const n=I(e);n.action=g("/run",t),n.target=E(t),document.body.appendChild(n),n.submit(),document.body.removeChild(n)}function h(e){return e?.contentWindow?(L(e)??new k(e)).pending:Promise.reject("Provided element is not an iframe.")}function B(e,t){K(e,t)}function V(e,t){const n=g(`/edit/${e}`,t),r=E(t);window.open(n,r)}function G(e,t){const n=g(`/github/${e}`,t),r=E(t);window.open(n,r)}function W(e,t,n){const r=_(e),i=q(t,n),o=document.createElement("iframe");return w(r,o,n),o.contentDocument?.write(i),h(o)}function z(e,t,n){const r=_(e),i=document.createElement("iframe");return i.src=y(`/edit/${t}`,n),w(r,i,n),h(i)}function J(e,t,n){const r=_(e),i=document.createElement("iframe");return i.src=y(`/github/${t}`,n),w(r,i,n),h(i)}const X={connect:h,embedGithubProject:J,embedProject:W,embedProjectId:z,openGithubProject:G,openProject:B,openProjectId:V},Y={"src/app.tsx":`import { MetaProvider, Title } from "@solidjs/meta";
