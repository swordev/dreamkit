...
`};function Q(e){let t=e.appFile??"src/dreamkit.tsx";t.startsWith("/")&&(t=t.slice(1));const n={...Y,...e.files||{},[t]:e.appCode};if(e.pkgDependencies||e.pkgDevDependencies){const r=n["package.json"]?JSON.parse(n["package.json"]):{};r.dependencies={...r.dependencies,...e.pkgDependencies},r.devDependencies={...r.devDependencies,...e.pkgDevDependencies},n["package.json"]=JSON.stringify(r,null,2)}return n}function Z(e){return{template:"node",title:"Dreamkit Example",description:"Example",...e||{},files:Q(e)}}function ee(e,t={}){let n=e.appFile??"src/dreamkit.tsx";n.startsWith("/")&&(n=n.slice(1)),X.openProject(Z(e),{openFile:[n],...t||{}})}export{Q as b,ee as o};
